...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bursar_creditcarddetail', 'iin_number', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        db.remove_column('bursar_creditcarddetail', 'iin_number', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True))
