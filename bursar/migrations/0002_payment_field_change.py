...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditCardDetail.payment'
        db.alter_column('bursar_creditcarddetail', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, unique=True, null=True, to=orm['bursar.Payment']))
    
    
    def backwards(self, orm):
        
        # Changing field 'CreditCardDetail.payment'
        db.alter_column('bursar_creditcarddetail', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['bursar.Payment']))
