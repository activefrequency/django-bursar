...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bursar_refund', (
            ...
            ('purchase', self.gf('django.db.models.fields.related.ForeignKey')(related_name='refunds', to=orm['bursar.Purchase'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('bursar', ['Refund'])


    def backwards(self, orm):
        
        # Deleting model 'Refund'
        db.delete_table('bursar_refund')
