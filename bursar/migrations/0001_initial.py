...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bursar_purchase', (
            ...
            ('sub_total', self.gf('bursar.fields.CurrencyField')(null=True, max_digits=18, decimal_places=2, blank=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('total', self.gf('bursar.fields.CurrencyField')(max_digits=18, decimal_places=2)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('tax', self.gf('bursar.fields.CurrencyField')(null=True, max_digits=18, decimal_places=2, blank=True)),
            ...
            ('shipping', self.gf('bursar.fields.CurrencyField')(null=True, max_digits=18, decimal_places=2, blank=True)),
        ...
        db.create_table('bursar_recurringlineitem', (
            ...
            ('trial', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
    ...
    models = {
        ...
        'bursar.recurringlineitem': {
            ...
            'trial': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
