...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Authorization.customer_profile_id'
        db.add_column('bursar_authorization', 'customer_profile_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Authorization.customer_profile_id'
        db.delete_column('bursar_authorization', 'customer_profile_id')
