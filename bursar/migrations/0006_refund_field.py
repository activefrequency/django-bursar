...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Refund.subtract_for_remaining'
        db.add_column('bursar_refund', 'subtract_for_remaining', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Refund.subtract_for_remaining'
        db.delete_column('bursar_refund', 'subtract_for_remaining')
    ...
    models = {
        ...
        'bursar.refund': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'purchase': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'refunds'", 'to': "orm['bursar.Purchase']"}),
            'reason_code': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subtract_for_remaining': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'max_length': '45', 'null': 'True', 'blank': 'True'})
        },
